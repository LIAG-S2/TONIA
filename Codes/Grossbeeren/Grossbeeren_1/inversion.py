...
farmName_Processed = 'Großbeeren_1_HLOF'
farmName_Original = 'Großbeeren_1'
data_type_HLOF = 'LOF'
...
fig, ax = plt.subplots(nrows=3, ncols=5, sharex=True, sharey=True, figsize=(11, 6), 
...
with PdfPages(pdf_filename) as pdf:
    ...
    ax.set_aspect(1.0)
    ax.set_title(f"$\chi^2$ for {farmName_Processed}".format(i * 0.1, (i + 1) * 0.1))
    # Add color bar
