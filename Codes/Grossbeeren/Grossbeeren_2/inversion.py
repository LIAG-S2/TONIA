...
filepath_Original = 'Geophilus_aufbereitet_2024-01-31_15-13-53.txt'
...
filepath_Original = 'Geophilus_aufbereitet_2024-01-30_11-23-14.txt'
farmName_Original = 'Großbeeren_2'
...
farmName_Processed = 'Großbeeren_2_HLOF'
farmName_Original = 'Großbeeren_2'
data_type_HLOF = 'LOF'
...
fig, ax = plt.subplots(nrows=3, ncols=5, sharex=True, sharey=True, figsize=(10, 8))
...
with PdfPages(pdf_filename) as pdf:
    for i in range(15):  # Loop through all subplots
        ...
        norm = LogNorm(10, 1000)
        rho = inv_res[:, i + 2]  # Assuming the rho values start from the third column
        im = ax.scatter(inv_res[:, 0] - x_offset, inv_res[:, 1] - y_offset, c=rho, s=1, norm=norm, cmap="Spectral_r", alpha=1)
        #ax.set_aspect(1.0)
